...
class ImageCollectionServiceTest {
    ...
    void testTechWebsiteImageCollection() {
        ImageCollectionResult result = imageCollectionService.collectImages("创建一个技术博客网站，需要展示编程教程和系统架构");
    ...
    void testEcommerceWebsiteImageCollection() {
        ImageCollectionResult result = imageCollectionService.collectImages("创建一个电商购物网站，需要展示商品和品牌形象");
        Assertions.assertNotNull(result);
